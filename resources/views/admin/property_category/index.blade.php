...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ url('admin/property-category/create') }}"><button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left"><b><i class="icon-plus-circle2"></i></b> Add {{$data['title']}}</button></a>
            </div>
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('admin.property-category.show', $val->id) }}" class="dropdown-item">
                                            <i class="icon-pencil7"></i> Edit
                                        </a>
                                        <a href="{{ route('admin.property-category.destroy', $val->id) }}" data-id="{{ $val->id }}" class="dropdown-item btnDelete">
