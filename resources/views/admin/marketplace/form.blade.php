        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.property-marketplace.store') : route('admin.property-marketplace.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
