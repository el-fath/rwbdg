        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.city.store') : route('admin.city.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
