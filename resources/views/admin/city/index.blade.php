...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.city.create') }}"><button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left"><b><i class="icon-plus-circle2"></i></b> Add {{$data['title']}}</button></a>
            </div>
        ...
        if(result.value) {
            ...
            $.ajax({
                ...
                beforeSend: function(){
                    ...
                    setTimeout(function(){ 
                        redirect('{{route('admin.city.index')}}');
                    }, 1500);
                })
                .fail(function(e) {
                    $('#tableData').unblock();
