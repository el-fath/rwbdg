        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.album.store') : route('admin.album.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="formid">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" required class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->{'title:id'} }}" placeholder="Title" name="id[title]">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                ...
                                <div class="tab-pane fade" id="formen">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-2">Title</label>
                                            <div class="col-lg-10">
                                                <input type="text" required class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->{'title:en'} }}" placeholder="Title" name="en[title]">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-2">Description</label>
        ...
        $("#formInput").submit(function(e){
            ...
            .done(function(data){
                ...
                if(data.Code == 200){
                    ...
                    setTimeout(function(){ 
                        redirect('{{route('admin.album.index')}}');
                    }, 1500);
                }else{
