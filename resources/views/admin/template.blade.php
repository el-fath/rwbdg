					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								<li class="media">
									<div class="mr-3">
										<img src="{{ url('public/assets/admin') }}/assets/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								...
								<li class="media">
									<div class="mr-3 position-relative">
										<img src="{{ url('public/assets/admin') }}/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
