...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.province.create') }}"><button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left"><b><i class="icon-plus-circle2"></i></b> Add {{$data['title']}}</button></a>
            </div>
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('admin.province.edit', $val->id) }}" class="dropdown-item">
                                            <i class="icon-pencil7"></i> Edit
                                        </a>
                                        <a href="{{ route('admin.province.destroy', $val->id) }}" data-id="{{ $val->id }}" class="dropdown-item btnDelete">
        ...
        if(result.value) {
            ...
            $.ajax({
                ...
                beforeSend: function(){
                    ...
                    setTimeout(function(){ 
                        redirect('{{route('admin.province.index')}}');
                    }, 1500);
                })
                .fail(function(e) {
                    $('#tableData').unblock();
